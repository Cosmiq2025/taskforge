/**
 * 1click v3 - Frontend Application
...
async function showTask(taskId) {
    try {
        ...
        if (wallet && task.status === 2 && task.client.toLowerCase() === wallet.toLowerCase()) {
            ...
            actions.innerHTML = '<p class="muted small">⏳ Waiting for 1click Agent to claim...</p>';
        } else if (task.status === 1) {
            actions.innerHTML = '<p class="muted small">🤖 1click Agent is processing...</p>';
